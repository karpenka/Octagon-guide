...
model.component('comp1').geom('geom1').feature('mir1').selection('input').set({'wp2' 'wp3' 'wp4' 'wp5' 'wp6' 'wp7' 'wp8' 'wp9'});
...
model.component('comp1').geom('geom1').feature('mir1').set('workplane', 'wp1');
model.component('comp1').geom('geom1').run('del8');
model.component('comp1').geom('geom1').create('mov1', 'Move');
model.component('comp1').geom('geom1').feature('mov1').selection('input').set({'wp2' 'wp3' 'wp4' 'wp5' 'wp6' 'wp7' 'wp8' 'wp9'});
model.component('comp1').geom('geom1').feature('mov1').set('workplane', 'wp1');
model.component('comp1').geom('geom1').feature('mov1').set('displz', 'L1');
model.component('comp1').geom('geom1').feature.remove('wp10');
...
model.component('comp1').geom('geom1').run('mir1');
model.component('comp1').geom('geom1').runPre('copy1');
model.component('comp1').geom('geom1').feature('copy1').set('workplane', 'wp1');
model.component('comp1').geom('geom1').feature('copy1').set('displz', 'L1');
model.component('comp1').geom('geom1').run('del8');
model.component('comp1').geom('geom1').feature.create('wp10', 'WorkPlane');
model.component('comp1').geom('geom1').feature('wp10').set('unite', true);
model.component('comp1').geom('geom1').feature('wp10').label('ww');
model.component('comp1').geom('geom1').feature('wp10').set('planetype', 'vertices');
model.component('comp1').geom('geom1').feature('wp10').selection('vertex1').set('del7', [10]);
model.component('comp1').geom('geom1').feature('wp10').selection('vertex2').set('del7', 6);
model.component('comp1').geom('geom1').feature('wp10').selection('vertex3').set('del7', 5);
model.component('comp1').geom('geom1').run('wp10');
model.component('comp1').geom('geom1').feature.remove('mir1');
model.component('comp1').geom('geom1').feature.remove('copy1');
model.component('comp1').geom('geom1').run('wp10');
model.component('comp1').geom('geom1').create('copy1', 'Copy');
model.component('comp1').geom('geom1').feature('copy1').selection('input').set({'wp2' 'wp3' 'wp4' 'wp5' 'wp6' 'wp7' 'wp8' 'wp9'});
model.component('comp1').geom('geom1').feature('copy1').set('displz', 'L1+L0');
model.component('comp1').geom('geom1').feature('copy1').set('workplane', 'wp10');
model.component('comp1').geom('geom1').feature('copy1').set('displz', 0);
model.component('comp1').geom('geom1').run('copy1');
model.component('comp1').geom('geom1').runPre('fin');
model.component('comp1').geom('geom1').runPre('copy1');
model.component('comp1').geom('geom1').runPre('fin');
...
model.component('comp1').geom('geom1').runPre('copy1');
model.component('comp1').geom('geom1').feature('copy1').set('workplane', 'wp1');
model.component('comp1').geom('geom1').feature('copy1').set('displz', 'L0+L1');
model.component('comp1').geom('geom1').runPre('fin');
model.component('comp1').geom('geom1').feature.remove('wp10');
model.component('comp1').geom('geom1').run('copy1');
model.component('comp1').geom('geom1').feature.create('wp10', 'WorkPlane');
model.component('comp1').geom('geom1').feature('wp10').set('unite', true);
model.component('comp1').geom('geom1').feature('wp10').set('planetype', 'vertices');
model.component('comp1').geom('geom1').feature('wp10').selection('vertex1').set('copy1(1)', 4);
model.component('comp1').geom('geom1').feature('wp10').selection('vertex2').set('copy1(1)', 1);
model.component('comp1').geom('geom1').feature('wp10').selection('vertex3').set('copy1(4)', 3);
model.component('comp1').geom('geom1').run('wp10');
model.component('comp1').geom('geom1').runPre('fin');
model.component('comp1').geom('geom1').run('wp10');
model.component('comp1').geom('geom1').create('mir1', 'Mirror');
model.component('comp1').geom('geom1').feature('mir1').selection('input').set({'copy1(2)'});
model.component('comp1').geom('geom1').feature('mir1').selection('input').init;
model.component('comp1').geom('geom1').feature('mir1').selection('input').set({'copy1(1)' 'copy1(2)' 'copy1(3)' 'copy1(5)' 'copy1(6)' 'copy1(7)' 'copy1(8)'});
model.component('comp1').geom('geom1').feature('mir1').set('workplane', 'wp10');
...
model.component('comp1').geom('geom1').feature('mov1').set('workplane', 'wp10');
...
model.component('comp1').geom('geom1').feature('mov2').set('workplane', 'wp10');
model.component('comp1').geom('geom1').feature('mov2').set('selresult', false);
model.component('comp1').geom('geom1').measure.selection.init;
model.component('comp1').geom('geom1').feature.remove('mov2');
model.component('comp1').geom('geom1').measure.selection.init;
model.component('comp1').geom('geom1').measure.selection.set({'wp2.pol1' 'wp3.pol1' 'wp4.pol1' 'wp5.pol1' 'wp6.pol1' 'wp7.pol1' 'wp8.pol1' 'wp9.pol1' 'del7(1)' 'del8(1)'  ...
'mov1(1)' 'mov1(2)' 'mov1(3)' 'mov1(4)' 'mov1(5)' 'mov1(6)' 'mov1(7)' 'mov1(8)'});
model.component('comp1').geom('geom1').measure.selection.init;
model.component('comp1').geom('geom1').measure.selection.set({'wp2.pol1' 'wp3.pol1' 'wp4.pol1' 'wp5.pol1' 'wp6.pol1' 'wp7.pol1' 'wp8.pol1' 'wp9.pol1' 'del7(1)' 'del8(1)'  ...
'mov1(1)' 'mov1(2)' 'mov1(3)' 'mov1(4)' 'mov1(5)' 'mov1(6)' 'mov1(7)' 'mov1(8)'});
model.component('comp1').geom('geom1').measure.selection.init;
...
'mov1(1)' 'mov1(2)' 'mov1(3)' 'mov1(4)' 'mov1(5)' 'mov1(6)' 'mov1(7)' 'mov1(8)'});
model.component('comp1').geom('geom1').measure.selection.init;
model.component('comp1').geom('geom1').measure.selection.set({'del7' 'mov1(8)'});
model.component('comp1').geom('geom1').measure.selection.init;
model.component('comp1').geom('geom1').measure.selection.set({'wp2.pol1' 'wp3.pol1' 'wp4.pol1' 'wp5.pol1' 'wp6.pol1' 'wp7.pol1' 'wp8.pol1' 'wp9.pol1' 'del7(1)' 'del8(1)'  ...
'mov1(1)' 'mov1(2)' 'mov1(3)' 'mov1(4)' 'mov1(5)' 'mov1(6)' 'mov1(7)' 'mov1(8)'});
model.component('comp1').geom('geom1').measure.selection.init;
...
model.component('comp1').geom('geom1').feature('wp11').selection('vertex1').set('del7', [6]);
model.component('comp1').geom('geom1').feature('wp11').selection('vertex2').set('del7', 10);
model.component('comp1').geom('geom1').feature('wp11').selection('vertex3').set('del7', 1);
model.component('comp1').geom('geom1').feature('wp11').label('fix_it');
model.component('comp1').geom('geom1').run('wp11');
model.component('comp1').geom('geom1').run('wp11');
model.component('comp1').geom('geom1').create('mov2', 'Move');
model.component('comp1').geom('geom1').feature('mov2').selection('input').set({'mov1'});
model.component('comp1').geom('geom1').feature('mov2').set('workplane', 'wp11');
model.component('comp1').geom('geom1').feature('mov2').set('disply', -3);
model.component('comp1').geom('geom1').feature('wp11').geom.measure.selection.init;
model.component('comp1').geom('geom1').feature('wp11').geom.measure.selection.set({});
model.component('comp1').geom('geom1').feature('wp11').geom.measure.selection.init;
model.component('comp1').geom('geom1').feature('wp11').geom.measure.selection.set({});
model.component('comp1').geom('geom1').feature('wp11').geom.measure.selection.init;
model.component('comp1').geom('geom1').feature('wp11').geom.measure.selection.set({});
...
model.component('comp1').geom('geom1').feature('wp11').geom.measure.selection.init;
model.component('comp1').geom('geom1').feature('wp11').geom.measure.selection.set({});
model.component('comp1').geom('geom1').feature('mov2').set('disply', -0.01);
model.component('comp1').geom('geom1').run('mov2');
model.component('comp1').geom('geom1').run('mov2');
model.component('comp1').geom('geom1').create('rot1', 'Rotate');
model.component('comp1').geom('geom1').feature('rot1').selection('input').set({'mov2'});
model.component('comp1').geom('geom1').feature('rot1').set('rot', 90);
model.component('comp1').geom('geom1').feature('rot1').set('axistype', 'y');
model.component('comp1').geom('geom1').feature('rot1').set('workplane', 'wp11');
model.component('comp1').geom('geom1').feature('rot1').set('axistype', 'z');
model.component('comp1').geom('geom1').feature.remove('rot1');
model.component('comp1').geom('geom1').run('mov2');
model.component('comp1').geom('geom1').feature.create('wp12', 'WorkPlane');
model.component('comp1').geom('geom1').feature('wp12').set('unite', true);
model.component('comp1').geom('geom1').feature('wp12').label('rot_plane');
model.component('comp1').geom('geom1').feature('wp12').set('quickplane', 'xy');
model.component('comp1').geom('geom1').feature('wp12').set('planetype', 'coordinates');
model.component('comp1').geom('geom1').feature('wp12').setIndex('genpoints', 'L0+', 0, 2);
model.component('comp1').geom('geom1').feature('wp12').setIndex('genpoints', 'L0+L1', 0, 2);
model.component('comp1').geom('geom1').feature('wp12').setIndex('genpoints', '2*L0+L1', 0, 2);
model.component('comp1').geom('geom1').feature('wp12').set('planetype', 'vertices');
model.component('comp1').geom('geom1').feature('wp12').selection('vertex1').set('mov2(8)', 1);
model.component('comp1').geom('geom1').feature('wp12').selection('vertex2').set('mov2(3)', 1);
model.component('comp1').geom('geom1').feature('wp12').selection('vertex3').set('mov2(7)', 4);
model.component('comp1').geom('geom1').feature('wp12').set('displ', {'width/2' 'height/2'});
model.component('comp1').geom('geom1').run('wp12');
model.component('comp1').geom('geom1').run('wp12');
model.component('comp1').geom('geom1').create('rot1', 'Rotate');
model.component('comp1').geom('geom1').feature('rot1').selection('input').set({'mov2'});
model.component('comp1').geom('geom1').feature('rot1').set('workplane', 'wp12');
model.component('comp1').geom('geom1').feature('rot1').set('rot', 90);
...
model.component('comp1').mesh('mesh1').export.set('filename', 'D:\JOB\github\Octagon-guide\simulation\new_shit\jason.stl');
model.component('comp1').mesh('mesh1').export('D:\JOB\github\Octagon-guide\simulation\new_shit\jason.stl');
