...
model.modelPath('D:\JOB\github\Octagon-guide\simulation\new_shit');
...
model.param.set('L0', '5');
model.param.set('L1', '2');
model.param.set('L2', '5');
...
model.component('comp1').geom('geom1').runPre('wp10');
model.component('comp1').geom('geom1').feature('wp10').selection('vertex1').set('wp6', 3);
model.component('comp1').geom('geom1').feature('wp10').selection('vertex2').set('wp4', 1);
model.component('comp1').geom('geom1').feature('wp10').selection('vertex3').set('wp8', 4);
model.component('comp1').geom('geom1').feature('wp10').set('displ', {'height/2' 'width/2'});
model.component('comp1').geom('geom1').run('wp10');
model.component('comp1').geom('geom1').feature('wp10').label('test');
model.component('comp1').geom('geom1').feature('wp10').set('offset', 'L0+L1/2');
model.component('comp1').geom('geom1').feature('wp10').set('reverse', true);
model.component('comp1').geom('geom1').feature('wp10').set('offset', '-(L0+L1/2)');
model.component('comp1').geom('geom1').run('wp10');
model.component('comp1').geom('geom1').run('wp10');
...
model.component('comp1').geom('geom1').feature('copy1').set('displz', 'L0*3');
...
model.component('comp1').geom('geom1').feature('mov1').selection('input').set({'copy1'});
model.component('comp1').geom('geom1').feature('mov1').set('workplane', 'wp10');
model.component('comp1').geom('geom1').feature('mov1').set('displz', '2*L0');
model.component('comp1').geom('geom1').run('mov1');
model.component('comp1').geom('geom1').feature('mov1').set('displz', '-2*L0');
model.component('comp1').geom('geom1').run('mov1');
model.component('comp1').geom('geom1').feature('mov1').set('displz', '-3*L0');
model.component('comp1').geom('geom1').run('mov1');
model.component('comp1').geom('geom1').run('mov1');
...
model.component('comp1').geom('geom1').feature('wp11').label('rot_pl');
model.component('comp1').geom('geom1').feature('wp11').set('planetype', 'vertices');
model.component('comp1').geom('geom1').feature('wp11').selection('vertex1').set('mir1(8)', 2);
model.component('comp1').geom('geom1').feature('wp11').selection('vertex1').clear('mir1(8)');
model.component('comp1').geom('geom1').feature('wp11').selection('vertex1').set('mir1(2)', [2]);
model.component('comp1').geom('geom1').feature('wp11').selection('vertex1').clear('mir1(2)');
model.component('comp1').geom('geom1').feature('wp11').selection('vertex1').set('mir1(8)', [2]);
model.component('comp1').geom('geom1').feature('wp11').selection('vertex2').set('mir1(2)', 2);
model.component('comp1').geom('geom1').feature('wp11').selection('vertex3').set('mir1(6)', 2);
model.component('comp1').geom('geom1').feature('wp11').set('displ', {'a/2' 'a/2+b/2'});
